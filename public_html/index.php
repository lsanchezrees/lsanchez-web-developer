...
<html lang="en" >
	...
	<script src='https://www.google.com/recaptcha/api.js'></script>
		<title>Leonora Sanchez-Rees, Web Developer</title>
	...
	<body class="sfooter">
		...
		<div id="home" class="home center-block">
			<div class="text-left">
				<h2>Leonora Sanchez-Rees</h2>
				<h3>Web Developer</h3>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-6 col-sm-offset-6">
						<h3>My focus as a web developer</h3>
						<h4>I am trained as a full stack web developer.  I have a certificate in Media Arts with an emphasis in web design.  I have recently completed a Deep Dive Coding Bootcamp in order to gain experience in all aspects of web development.</h4>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 text-center">
						<p><a class="up-arrow" href="#top-of-page" data-toggle="tooltip" title="TO TOP">
			...
			<div class="row">
				<div class="col-sm-12">
					<form id="contact-form" action="php/mailer.php" method="post">
						...
						<!-- reCAPTCHA -->
						<div class="g-recaptcha" data-sitekey="6Lc-9C4UAAAAAPK8J7foJo4DhihuFaHlER1fwBCM"></div>
		...
		<footer><p><a class="up-arrow" href="#top-of-page" data-toggle="tooltip" title="TO TOP">
				<span class="glyphicon glyphicon-chevron-up"></span>
				</a></p>
			<p>&copy; 2017 Leonora Sanchez-Rees</p></footer>
	</body>
</html>